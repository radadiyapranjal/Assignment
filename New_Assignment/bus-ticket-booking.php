    ...
    <section class="breadcrumb-area bread-bg">
        ...
        <div class="container">
            <div class="breadcrumb-content text-center">
                <h2 class="sec__title text-white mb-3">Bus Ticket Booking</h2>
                <!-- <ul class="bread-list">
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text mt-3">
                                <i class="bi bi-geo-alt-fill"></i> Delhi &nbsp; <b>--</b>&nbsp; <i class="bi bi-geo-alt-fill"></i> Manali <br>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-items mt-3">
                                ...
                                <li class="d-flex align-items-center justify-content-between">
                                    ...
                                    <span class="text-success">&#8377;1300./</span>
                                </li>
                            </ul>
                        </div>
                        <!-- end card-body -->
                ...
                <div class="col-lg-8">
                    ...
                    <!-- end card -->
                    <a href="booking-confirmation" class="theme-btn">Confirm and Pay</a>
                </div>
            </div>
        </div>
        <!-- end container -->
