...
<head>
    ...
    <title>Trip Booking Details-Trip24</title>
    <!-- Google Fonts -->
    ...
    <section class="breadcrumb-area bread-bg">
        <div class="container">
            <div class="breadcrumb-content text-center text-black">
                <h2 class="sec__title text-black mb-3">Trip Booking Details</h2>
                <ul class="bread-list ">
                    <li><a href="index" style="color:black">Home</a></li>
                    <li style="color:black;">Trip Booking Details</li>
                </ul>
            </div>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <a href="#" class="card-image">
                            <img src="images/img-loading.jpg" data-src="https://cdn.pixabay.com/photo/2020/04/28/04/17/monastery-5102601_640.jpg" class="card-img-top lazy"
                                alt="card image" />
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-items mt-3">
                                <li class="d-flex align-items-center justify-content-between">
                                    <span class="text-black">Trip Duration</span> 5 Days
                                </li>
                                <li class="d-flex align-items-center justify-content-between">
                                    <span class="text-black">Destination(s)</span> Manali
                                </li>
                                <li class="d-flex align-items-center justify-content-between">
                                ...
                                <li class="d-flex align-items-center justify-content-between">
                                    ...
                                    <span class="text-success">₹29,999</span>
                                </li>
                            </ul>
                        </div>
                        <!-- end card-body -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6 pr-lg-0">
                                    ...
                                    <input class="form-control form--control ps-3" type="text" name="first_name"
                                        placeholder="First name" />
                                </div>
                                <!-- end form-group -->
                                <div class="form-group col-lg-6">
                                    <label class="label-text">Last Name</label>
                                    <input class="form-control form--control ps-3" type="text" name="last_name"
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input class="form-control form--control ps-3" type="text" name="phone"
                                ...
                                <li class="active">
                                    ...
                                    <div class="expanded-payment-method">
                                        <p>
                                            ...
                                            Booking ID as the payment reference. Your booking won't be confirmed
                                    ...
                                    <div class="expanded-payment-method">
                                        <div class="row">
                                            <div class="form-group col-lg-6 pr-lg-0">
                                                ...
                                                <input class="form-control form--control ps-3" type="text" name="card_name"
                                                    placeholder="Name on Card" />
                                            </div>
                                            <!-- end form-group -->
                                            <div class="form-group col-lg-6">
                                                <label class="label-text">Card Number</label>
                                                <input class="form-control form--control ps-3" type="text" name="card_number"
                                                    placeholder="1234 5678 9123 4567" />
                                            </div>
                                            <!-- end form-group -->
                                            <div class="form-group col-lg-4 pr-lg-0">
                                                <label class="label-text">Expiry Month</label>
                                                <input class="form-control form--control ps-3" type="text" name="expiry_month"
                                                    placeholder="MM" />
                                            </div>
                                            <!-- end form-group -->
                                            <div class="form-group col-lg-4 pr-lg-0">
                                                <label class="label-text">Expiry Year</label>
                                                <input class="form-control form--control ps-3" type="text" name="expiry_year"
                                                    placeholder="YY" />
                                            </div>
                                            <!-- end form-group -->
                                            <div class="form-group col-lg-4">
                                                <label class="label-text">CVV</label>
                                                <input class="form-control form--control ps-3" type="text" name="cvv"
                                                    placeholder="CVV" />
                                            </div>
                                            <!-- end form-group -->
                                        </div>
