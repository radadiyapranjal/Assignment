    ...
    <section class="blog-area padding-top-60px padding-bottom-90px">
        <div class="container">
                ...
                <div class="sidebar">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body ">
                            ...
                            $journeyDate = isset($_GET['DateOfJourney']) ? $_GET['DateOfJourney'] : '';
                            
                            // Convert date format from YYYY-MM-DD to DD-MM-YYYY
                            $formattedDate = $journeyDate ? date("d-m-Y", strtotime($journeyDate)) : '';
                            ?>
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <select name="OriginId" class="form-control form--control select">
                                    ...
                                    <option value="8463" <?= $originId == '8463' ? 'selected' : '' ?>>Delhi</option>
                                    <option value="8475" <?= $originId == '8475' ? 'selected' : '' ?>>Chandigarh</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <select name="DestinationId" class="form-control form--control select">
                                    <option disabled>Select Drop Location</option>
                                    <option value="9573" <?= $destinationId == '9573' ? 'selected' : '' ?>>Shimla</option>
                                    <option value="9585" <?= $destinationId == '9585' ? 'selected' : '' ?>>Manali</option>
                                </select>
                            </div>
                            
                            <div class="form-group col-lg-3">
                                <span class="fas fa-calendar form-icon"></span>
                                <input type="text" name="DateOfJourney" class="form-control form--control" value="<?= $formattedDate ?>" readonly>
                            </div>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "GET") {
                ...
                $url = "https://staging.mmrtrip.in/busservice/rest/search";
                // Sanitize inputs
