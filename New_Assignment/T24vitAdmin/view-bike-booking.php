                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">View Bike Booking Detail</h5>
                                            ...
                                            <div class="cardbg">
                                                ...
                                                <div class="progress-section">
                                                    <div class="progress-title mb-2">
                                                        <span class="title">Vendor Id</span>
                                                        <span class="float-right">Uyr456789</span>
                                                    </div>
                                                </div>
                                                <div class="progress-section">
                                                    <div class="progress-title mb-2">
                                                        <span class="title">Bike Number</span>
                                                ...
                                                <div class="progress-section">
                                                    <div class="progress-title mb-2">
                                                        ...
                                                        <span class="float-right">07</span>
                                                    </div>
                                                </div>
                                                <div class="progress-section">
                                                    <div class="progress-title mb-2">
                                                        <span class="title">Return Bike Date</span>
                                                        <span class="float-right">15/09/2024</span>
                                                    </div>
                                                </div>
                                                <div class="progress-section">
                                                    <div class="progress-title mb-2">
