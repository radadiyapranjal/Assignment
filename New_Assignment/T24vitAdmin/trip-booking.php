...
<head>
    <meta charset="UTF-8">
    <title>View Trip Booking - Trip-24</title>
            ...
            <div class="card panel panel-default">
                <div class="card-header" id="headingTwo">
                    <div class="panel-heading">
                        <h6 class="title-inner text-uppercase">View Trip Booking</h6>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">View Trip Booking Detail</h5>
                                            ...
                                            <div class="cardbg">
                                                ...
                                                <div class="progress-section">
                                                    <div class="progress-title mb-2">
                                                        <span class="title">Customer Id</span>
                                                        <span class="float-right">oyr456789</span>
                                                    </div>
                                                </div>
                                                <div class="progress-section">
                                                    <div class="progress-title mb-2">
                                                        <span class="title">Package Id</span>
                                                        <span class="float-right">Trip-986542</span>
                                                    </div>
                                                </div>
                                                <div class="progress-section">
                                                    <div class="progress-title mb-2">
                                                        <span class="title">Booking Date</span>
                                                        <span class="float-right">12/06/2024</span>
                                                    </div>
                                                </div>
                                                <div class="progress-section">
                                                    <div class="progress-title mb-2">
                                                        <span class="title">Start Date</span>
                                                        <span class="float-right">15/06/2024</span>
                                                    </div>
                                                </div>
                                                <div class="progress-section">
                                                    <div class="progress-title mb-2">
                                                        <span class="title">Amount</span>
                                                        <span class="float-right">6000./</span>
                                                    </div>
                                                </div>
                                                <div class="progress-section">
                                                    <div class="progress-title mb-2">
                                                        <span class="title">Status</span>
                                                        <span class="float-right">Hide</span>
                                                    </div>
                                                </div>
                                            </div>
