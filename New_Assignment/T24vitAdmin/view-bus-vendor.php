...
<head>
    <meta charset="UTF-8">
    <title>View Bus Vendor - Trip-24</title>
            ...
            <div class="card panel panel-default">
                <div class="card-header" id="headingTwo">
                    <div class="panel-heading">
                        <h6 class="title-inner text-uppercase">View Bus Vendor</h6>
                    ...
                    <table id="example1" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="view-bus-vendor-details" type="button" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> View</a>&nbsp;<button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
